...
INSERT INTO `detallespedidos` (`idPedido`, `idArticulo`, `cantidad`) VALUES
(1, 4, 5),
(1, 11, 6),
(1, 15, 6),
(2, 2, 77),
...
ALTER TABLE `detallespedidos`
  ...
  ADD KEY `id_Articulo` (`idArticulo`);
...
--
ALTER TABLE `detallespedidos`
  ADD CONSTRAINT `detallespedidos_ibfk_1` FOREIGN KEY (`idArticulo`) REFERENCES `articulos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
